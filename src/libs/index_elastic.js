 ...
 */
     ...
     * 
     * Fetches data from elastic api or exhibits app backend api
     */
    export const Index = (() => {
        ...
        const getExhibit = async (id) => {
            ...
            try {  
                ...
                // TODO
                //let items = await axios.get(`${exhibitsIndexDomain}/exhibitsIndexName/_search`, {query: {'is_member_of': id});
                // TODO backend api
