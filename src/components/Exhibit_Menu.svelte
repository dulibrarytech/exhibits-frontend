<script>
    ...
    <div class="exhibit-menu box-shadow-bottom">

        <!-- <div class="container"> -->
            <div class="d-flex flex-column flex-md-row align-items-left py-2 px-4">
                <nav class="d-flex align-items-center text-dark text-decoration-underline">
